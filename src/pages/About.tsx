        ...
        <div className="row g-5 align-items-start">
         <div className="col-4 col-md-3 text-start text-md-center">
          ...
          <div className="col-md-9" style={{ maxWidth: "46rem", color:"#DBDBDB" }}>
            <p>Signature Sound Studio is founded with a passion for audio excellence. Our studio combines cutting-edge technology with a team of skilled sound engineers and producers. We work closely with artists, businesses, and content creators to bring their vision to life.</p>
            <p>From live recording to music production to voiceovers, podcasts, and sound design, we provide a professional environment where creativity thrives and quality is guaranteed.</p>
          </div>
        </div>
      </section>
